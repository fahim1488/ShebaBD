...
// ─── Standard Hero Slide Data ────────────────────────────────────────────────
const HERO_SLIDES = [
  {
    id: 1,
    image: '/hero-slide1.jpg',
    badge: 'Disaster Relief & Response',
    headline: 'Emergency Flood Relief Across 64 Districts',
    sub: 'Deploying immediate rescue units, food packs, and clean drinking water to flood-affected communities with live GPS tracking.',
    ctaPrimary: { label: 'Request Emergency Help', href: ROUTES.EMERGENCY },
    ctaSecondary: { label: 'Support Relief', href: ROUTES.DONATE },
  },
  {
    id: 2,
    image: '/hero-slide2.jpg',
    badge: 'Community Volunteering',
    headline: 'Mobilizing 18,000+ Verified Youth Volunteers',
    sub: 'Connecting passionate citizens with registered NGOs and social service campaigns across Bangladesh in real-time.',
    ctaPrimary: { label: 'Join as Volunteer', href: ROUTES.VOLUNTEERS },
    ctaSecondary: { label: 'Browse NGOs', href: ROUTES.ORGANIZATIONS },
  },
  {
    id: 3,
    image: '/hero-slide3.jpg',
    badge: 'Healthcare & Life Saving',
    headline: 'Instant AI-Powered Blood Donor Matching',
    sub: 'Connecting critical hospital patients with compatible nearby blood donors in minutes. Every drop counts.',
    ctaPrimary: { label: 'Find Blood Donor', href: ROUTES.BLOOD_DONATION },
    ctaSecondary: { label: 'Register as Donor', href: ROUTES.BLOOD_DONATION },
  },
  {
    id: 4,
    image: '/hero-slide4.jpg',
    badge: 'Education & Child Welfare',
    headline: 'Empowering the Next Generation of Bangladesh',
    sub: 'Supporting underprivileged children with educational kits, digital classrooms, and nutrition programs in rural schools.',
    ctaPrimary: { label: 'Sponsor a Child', href: ROUTES.DONATE },
    ctaSecondary: { label: 'Upcoming Events', href: ROUTES.EVENTS },
  },
  {
    id: 5,
    image: '/hero-slide5.jpg',
    badge: 'Civic Technology Ecosystem',
    headline: 'Transparent Civic Ecosystem Powered by AI',
    sub: 'Real-time donation tracking, verified NGO credibility ratings, and automated disaster response intelligence.',
    ctaPrimary: { label: 'Explore Directory', href: ROUTES.ORGANIZATIONS },
    ctaSecondary: { label: 'AI Smart Search', href: ROUTES.AI_SMART_SEARCH },
  },
];
...
export default function Home() {
  ...
  return (
    <div style={{ background: INK, color: PAPER, overflowX: 'hidden' }}>
      ...
      {/* ════════════════════════════════════════════════════════════════════
          HERO CAROUSEL SECTION — STANDARD & BALANCED VISUALS
      ════════════════════════════════════════════════════════════════════ */}
      <section className="relative overflow-hidden flex flex-col justify-center min-h-[92vh] pt-28 pb-20">
        
        {/* Background Image Carousel with standard 65% opacity & smooth fade */}
        ...
        {/* Standard balanced gradient overlay: keeps text readable while showing photo clearly */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#061C14]/90 via-[#0B2E22]/65 to-[#061C14]/40" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#0B2E22]" />
          ...
          <div className="flex flex-col items-start max-w-3xl">
            ...
            <AnimatePresence mode="wait">
              <motion.div
                ...
                className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/[0.08] border border-white/20 backdrop-blur-xl mb-6 text-xs font-mono-ibm font-medium text-amber-300 shadow-xl"
              >
            ...
            <AnimatePresence mode="wait">
              <motion.h1
                ...
                className="font-fraunces mb-5 text-4xl sm:text-5xl lg:text-6xl leading-[1.1] tracking-tight font-bold text-white drop-shadow-2xl max-w-2xl"
              >
                {slide.headline}
              </motion.h1>
            </AnimatePresence>
            ...
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="mb-8 text-base sm:text-lg leading-relaxed text-emerald-100/85 max-w-2xl drop-shadow"
              >
                {slide.sub}
              </motion.p>
            </AnimatePresence>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 bg-white/10 hover:bg-white/20 border border-white/20 text-white backdrop-blur-md hover:-translate-y-0.5"
                >
            ...
            <div className="w-full max-w-2xl mb-8">
              <form
                ...
                className="relative flex items-center w-full rounded-2xl bg-white/[0.08] backdrop-blur-2xl border border-white/20 p-2 shadow-2xl transition-all duration-300 focus-within:border-amber-400/70 focus-within:bg-white/[0.12] focus-within:ring-4 focus-within:ring-amber-400/10 group"
              >
                ...
                <input
                  ...
                  className="w-full bg-transparent border-0 outline-none px-2 py-2.5 text-sm sm:text-base text-white placeholder:text-white/45 font-sans"
                />

                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-emerald-950 font-semibold text-sm transition-all duration-300 shadow-lg hover:shadow-amber-500/25 shrink-0"
                >
              ...
              {t.hero.quickLinks && t.hero.quickLinks.length > 0 && (
                <div className="flex flex-wrap items-center gap-2 mt-3 text-xs text-white/65">
                  <span className="font-mono-ibm text-[11px] uppercase tracking-wider text-amber-400/90 mr-1 flex items-center gap-1">
                  ...
                  {t.hero.quickLinks.map((linkText: string, idx: number) => (
                    <button
                      ...
                      className="px-3 py-1 rounded-full bg-white/[0.06] hover:bg-white/[0.14] border border-white/10 hover:border-amber-400/40 text-emerald-100/80 hover:text-white transition-all duration-200 text-left text-xs"
                    >
                      {linkText}
                    </button>
                  ))}
